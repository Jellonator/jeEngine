...
class Tilemap : public Canvas
{
	public:
		...
		int tileSpaceX;/**< \brief X spacing between tiles. */
		int tileSpaceY;/**< \brief Y spacing between tiles. */
		int widthInTiles;/**< \brief Width of the tileset, in tiles. */
		int heightInTiles;/**< \brief Height of the tileset, in tiles. */
		//Tilemap(std::string tmxFile, std::string layerName, std::string tileSetPath, int tWidth = -1, int tHeight = -1, int offsetX = 0, int offsetY = 0, int spaceX = 0, int spaceY = 0);
