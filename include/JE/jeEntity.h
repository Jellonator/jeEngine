...
class Entity : public Point, public std::enable_shared_from_this<Entity>
{
	...
	public:
		...
		virtual void OnAdd(const Group& group);/**< \brief Called when the entity is added to the world. */
		virtual void OnAdd(const World& world);/**< \brief Called when the entity is added to the world. */
		...
		virtual void OnRemove(const Group& group);/**< \brief Called when the entity is removed from the world. */
		virtual void OnRemove(const World& world);/**< \brief Called when the entity is removed from the world. */
